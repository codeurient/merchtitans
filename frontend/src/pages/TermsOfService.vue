<template xmlns="http://www.w3.org/1999/html">
    <main-template>
        <center-title-block title="<p>Terms</p><p>'of Service'</p>"
                            :background-image="bgImage"
                            :breadcrumbs="BREADCRUMBS"
        >
        </center-title-block>
        <section class="flex flex-col items-center bg-[#F8F8F9] mt-[-20px] pb-20">
            <v-ellipse/>
            <div class="mt-[-750px] w-1/2 justify-center z-10 bg-white py-10 px-12 rounded-3xl">
                <div class="text-center mb-8 font-bold text-2xl">Overview</div>
                <div class="flex gap-10">
                    <div class="basis-1/2 text-[#5D6483] text-base font-normal">
                        <p>This website is operated by Merch Titans, LLC. Throughout the site, the terms “we”, “us” and
                            “our” refer to Merch Titans, LLC. Merch Titans, LLC offers this website, including all
            ...
            <div class="w-3/5 text-[#27282D] mt-28 pl-24">
                <div class="mt-8" v-for="(item, index) in BLOCKS" :key="index">
                    <div class="font-bold text-2xl">{{ item.title }}</div>
                    <div class="mt-4 text-[#5D6483] text-base font-normal" v-html="item.paragraphs.map((el) => `<p>${el}</p>`).join('<br/>')">
                    </div>
                </div>
            </div>
            <div class="w-3/5 mt-12 pl-24">
                <information-card
                    title="SECTION 20 - CONTACT INFORMATION"
                >
                    <template v-slot:text>
                        <div class="text-base font-normal text-[#5D6483] max-w-[400px] mt-6">Questions about the Terms of Service should be sent to us at</div>
                        <div class="mt-8"><a href="mailto:info@merchtitans.com." target="_blank" class="text-[#8DF63A]">info@merchtitans.com.</a></div>
                    </template>
                    <template v-slot:image>
                        <img src="../assets/images/private_policy_and_terms_of_service/image2.svg" alt="">
                    </template>
                </information-card>
            </div>
        </section>
...
import bgImage from "../assets/images/title_block_background.svg";
...
const BLOCKS: Block[] = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'For more detail, please review our <a href="/cancellation-policy" target="_blank" class="text-[#7879F1]">Cancellation Policy.</a>',
        ]
    },
    {
    ...
    },
    {
        ...
        paragraphs: [
            'Your submission of personal information through the store is governed by our <span class="font-bold text-[#5D6483]">Privacy Policy</span>. To view our <a href="/privacy-policy" target="_blank" class="text-[#7879F1]">Privacy Policy</a>.',
        ]
    },
    {
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'In no case shall Merch Titans, LLC, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.',
        ]
    },
    {
        title: 'SECTION 14 - INDEMNIFICATION',
        paragraphs: [
            'You agree to indemnify, defend and hold harmless Merch Titans, LLC and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.',
        ]
    },
    {
    ...
    },
    {
        ...
        paragraphs: [
            'These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of 10670 Pueblo Springs Street, Las Vegas, NV, 89183, United States.',
        ]
    },
    {
    ...
    },
    {
        title: 'SECTION 20 - CONTACT INFORMATION',
        paragraphs: [
            'Questions about the Terms of Service should be sent to us at <a href="mailto:info@merchtitans.com" target="_blank" class="text-[#7879F1]">info@merchtitans.com</a>.',
        ]
    },
]
